...
# For Bayes factors require 10x usual amount than parameter estimation
N_ITERATIONS = 20000
...
if (RECALCULATE_MODELS) { 
  ...
  # 
  # Use informative prior for effect of number of children based upon three
  # previous studies
  #
  # older age == earlier year thus reversal of sign for effect
